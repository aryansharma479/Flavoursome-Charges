...
def pizza():
        print("\n\n_____WELCOME TO PIZZA CORNER_______\n\n")
        print("")
        time.sleep(1)
        print("")
        ...
        while (c=="y"):
            ...
            if (ch==1):
                name=input("Enter Name Of Pizza:")
                ...
                if (data==[]):
                    ...
                    data.pop(0)
                    name=input("ENTER ABOVE NAME OF PIZZA TO BE DELETED FROM MYSQL DATA:")
