...
def sweetscorner():
        print("\n\n_____WELCOME TO SWEETS CORNER_______\n\n")
        print("")
        time.sleep(1)
        print("")
        ...
        while (c=="y"):
            ...
            if (ch==1):
                ...
                qty=int(input("Enter Quantity (No.of Boxes Of Sweets):"))
                ...
                if (data==[]):
                    ...
                    print("DELETED ELEMENT IS:",data[0])
                    data.pop(0)
                ...
                print("DELETED ELEMENT IS:",data[index])
                data.pop(index)
                name=input("ENTER ABOVE NAME OF ITEM TO BE DELETED FROM MYSQL DATA:")
                sql = "DELETE FROM food WHERE Name_of_item = %s"
                name = (name,)
            ...
            if c=="n":
                if (data==[]):
                            ...
                            df=pd.DataFrame((data),columns=['Name Of Items','Fixed Mrp','Qty','Price','Amount',
                                                            'Saved_Amt','Total Saved Amount'])
                            print(df)
